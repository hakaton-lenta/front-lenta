        ...
        <div className='filter'>
            ...
            <Collapse
                ...
                <FormControl sx={{ m: 1, width: 200 }}>
                    <InputLabel sx={{ fontSize: '16px', fontWeight: 400, width: '100%' }} id="select-label-1">Код ТК</InputLabel>
                    <Select
                ...
                <FormControl sx={{ m: 1, width: 200 }}>
                    <InputLabel sx={{ fontSize: '16px', fontWeight: 400, width: '100%' }} id="select-label-1">Группа товаров</InputLabel>
                    <Select
                ...
                <FormControl sx={{ m: 1, width: 200 }}>
                    <InputLabel sx={{ fontSize: '16px', fontWeight: 400, width: '100%' }} id="select-label-1">Категория товаров</InputLabel>
                    <Select
                        sx={{ width: 200, marginRight: 2.5 }}
                ...
                <FormControl sx={{ m: 1, width: 200 }}>
                    <InputLabel sx={{ fontSize: '16px', fontWeight: 400, width: '100%' }} id="select-label-1">Подкатегория товаров</InputLabel>
                    <Select
                        sx={{ width: 200, marginRight: 2.5 }}
                ...
                <FormControl sx={{ m: 1, width: 200 }}>
                    <InputLabel sx={{ fontSize: '16px', fontWeight: 400, width: '100%' }} id="select-label-1">Период прогнозирования</InputLabel>
                    <Select
                        sx={{ width: 200, marginRight: 2.5 }}
                ...
                <Button sx={{
                    width: '265px', backgroundColor: '#003C96', color: 'white', fontSize: '16px', fontWeight: '400', height: '56px', margin: '8px 0 8px 40px', '&:hover': {
