...
import { FetchDownloadCsv, FetchDownloadXlsx } from '../../utils/downloadAPI';
    ...
    if (targets.length > 0 && dates.length > 0){
      return (
        <div className="" style={{ margin: '40px 24px', width: '100vw' }}>
          <Features title={'Прогнозирование спроса товаров'} />
          <Grid container rowSpacing={3} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
            ...
            <Grid item xs={9}>
              <CustomPaper style={{ padding: '0' }}>
                ...
                >
                  <TitleGraph>Спрогнозированные продажи</TitleGraph>
                </TitleGraphBlock>
