    ...
    const handleRemoveChip = (field: string, value: string) => {
        switch (field) {
            ...
            case 'category':
                ...
                break;
            case 'subcategories':
                dispatch(setSubcategories(subcategories.filter((item) => item !== value)));
                break;
            case 'sku':
    ...
    return (
        <div className="forecast" style={{ margin: '40px 24px', width:'100vw' }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
                <Typography sx={{ fontSize: '32px', fontWeight: '500', lineHeight: '42px' }}>Прогнозирование спроса товаров</Typography>
                <Box
                    sx={{
                        display: 'flex',
                        backgroundColor: '#fff',
